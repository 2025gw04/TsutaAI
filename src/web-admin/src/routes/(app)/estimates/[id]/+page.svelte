<script lang="ts">
	...
	$: estimateId = parseInt($page.params.id ?? '0', 10);
	...
	<div class="page-actions">
		...
		<div class="action-group">
			...
			{#if estimate?.status === 'completed'}
				<button class="action-btn warning" on:click={handleReopen} disabled={isDeleting}>
			...
			{/if}
			<button class="action-btn danger" on:click={handleDelete} disabled={isDeleting}>
