	...
	async function initializeDatabase() {
		...
		try {
			...
			if (response.success) {
				...
				error = response.error || '初期化に失敗しました。';
			}
		} catch (e: any) {
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-center mb-3">
									...
									<button type="button" class="btn btn-primary" on:click={openCreateUserModal}>
										<i class="bi bi-plus-lg me-1"></i>
										ユーザーを追加
									</button>
								</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<button
						type="button"
						class="btn-close"
						on:click={() => (showAddHolidayModal = false)}
						aria-label="閉じる"
					></button>
				</div>
				<div class="modal-body">
					<form on:submit|preventDefault={addHoliday}>
						...
						<div class="mb-3">
							...
							<select class="form-select" id="holidayType" bind:value={newHoliday.holiday_type}>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" on:click={addHoliday}> 追加 </button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<button
						type="button"
						class="btn-close"
						on:click={() => (showImportHolidayModal = false)}
						aria-label="閉じる"
					></button>
				</div>
				<div class="modal-body">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" on:click={importHolidaysInRange}>
						<i class="bi bi-download me-1"></i>
						インポート
					</button>
				</div>
	...
	<div class="modal show d-block" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form on:submit|preventDefault={saveUser}>
						...
						<div class="mb-3">
							...
							<select class="form-select" id="role" bind:value={userForm.role}>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" on:click={() => (showUserModal = false)}>
						キャンセル
					</button>
	...
	<div class="modal show d-block" tabindex="-1">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-warning me-auto" on:click={resetPrompt}>
					...
					<button type="button" class="btn btn-primary" on:click={savePrompt}>
