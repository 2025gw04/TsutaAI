    ...
    public partial class NotificationHistoryWindow : Window
    {
        ...
        private async System.Threading.Tasks.Task LoadNotifications()
        {
            try
            {
                ...
                var notifications = await _apiService.GetNotificationsAsync(unreadOnly: false);
                System.Diagnostics.Debug.WriteLine($"[NotificationHistoryWindow] Loaded {notifications.Count} notifications");
