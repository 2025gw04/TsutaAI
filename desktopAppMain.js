...
document.addEventListener("DOMContentLoaded", () => {
    console.log('=== DEBUG: Desktop App Manual Script Starting ===');
    ...
    const sectionCount = 6; // 6 sections for Desktop App
    ...
    async function loadSection(index) {
        ...
        try {
            const response = await fetch(`desktopAppSections/${fileName}`);
